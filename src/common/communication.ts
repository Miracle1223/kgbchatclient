...
// Incoming call popup (KGBChat custom)
export const CALLS_INCOMING_CALL = 'calls-incoming-call';
export const CALLS_INCOMING_CALL_ENDED = 'calls-incoming-call-ended';
export const CALLS_INCOMING_CALL_ACTION = 'calls-incoming-call-action';
export const INCOMING_CALL_ACTION = 'incoming-call-action';
export const INCOMING_CALL_DATA = 'incoming-call-data';
